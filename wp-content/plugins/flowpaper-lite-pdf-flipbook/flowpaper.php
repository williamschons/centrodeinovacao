...
define('FLOWPAPER_PLUGIN_VERSION', '1.8.9');
...
function flowpaper_plugin_add_shortcode_cb( $atts, $content="" ) {
    ...
    if($linkEmbed){
        ...
        $html          .= '<a data-lity href="' . $pdfUrl . (!$cloudhosted?('&title=' . $title . '&header=' . $header . '&theme=' . $theme .'&thumbs=' . $thumbs . '&modified=' . get_the_modified_date('ymdgi')):'') . '">';
