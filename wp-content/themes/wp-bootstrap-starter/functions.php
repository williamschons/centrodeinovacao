...
'public' => true,
'has_archive' => true,
'rewrite' => array( 'slug' => 'programacao' ),
'menu_position' => 5,
...
function create_posttypegotamentor(){
register_post_type( 'gotamentor',
array(
'labels' => array(
'name' => __( 'Mentores' ),
'singular_name' => __( 'Got a Mentor' )
),
'public' => true,
'has_archive' => true,
'rewrite' => array( 'slug' => 'gotamentor' ),
'menu_position' => 4,
'supports' => array ( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'custom-fields' )
)
);
}
add_action ( 'init', 'create_posttypegotamentor' );

function create_posttypemeetups(){
register_post_type( 'meetups',
array(
'labels' => array(
'name' => __( 'Meetups & Events' ),
'singular_name' => __( 'Meetups & Events' )
),
'public' => true,
'has_archive' => true,
...
add_action ( 'init', 'create_posttypemeetups' );

function create_posttypeworkshops(){
...
add_action ( 'init', 'create_posttypeworkshops' );
