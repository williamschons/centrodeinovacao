...
?>
		<div class="container">
			<div class="row">
           <div class="bannerinicialcombotoes">
<h1></h1>
<p>No <strong>Design Lab</strong> usamos as principais abordagens de resolução de problemas para gerar inovação, encontramos as melhores e mais criativas soluções de produtos e serviços com foco centrado nas necessidades dos pacientes</p>
<div class="col-sm"><a href="" alt="" style="padding:4%; background: #0000ff; color:#FFF; border-radius:1.618em;">Desafios</a></div>
<div class="col-sm"><a href="" alt="" style="padding:4%; background: #ffb6c1; color:#FFF; border-radius:1.618em;">Participe</a></div>
