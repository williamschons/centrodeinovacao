<?php
/**
 * Centro de Inovacao: Color Patterns
 *
 * @package WordPress
 ...
 */
function centrodeinovacao_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Centro de Inovacao default saturation level.
	 *
	 * @since Centro de Inovacao 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'centrodeinovacao_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.centrodeinovacao-front-page) .entry-title,
...
.colors-custom .centrodeinovacao-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.centrodeinovacao-front-page .panel-content .recent-posts article,
...
.colors-custom.centrodeinovacao-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Centro de Inovacao custom colors CSS.
	 *
	 * @since Centro de Inovacao 1.0
	 *
	 ...
	 */
	return apply_filters( 'centrodeinovacao_custom_colors_css', $css, $hue, $saturation );
}
